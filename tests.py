...
class TestRelatedness(unittest.TestCase):
	...
	def test_tso_no_one_related(self):
		result, comment = relatedness_test('testData/210709_NB551319_0232_AHF2JFBGXJ.ped', 'testData/210709_NB551319_0232_AHF2JFBGXJ.relatedness2')
		self.assertEqual(result, True)

	def test_tso_no_one_related_unexpected_related(self):

		# relatedness between 18M01316	21M11357 is 0.2
		result, comment = relatedness_test('testData/210709_NB551319_0232_AHF2JFBGXJ.ped', 'testData/210709_NB551319_0232_AHF2JFBGXJ_2.relatedness2')
		self.assertEqual(result, False)

	def test_big_genome_run(self):

		# Test run with 5 correct trios
		result, comment = relatedness_test('testData/K00150_0149_AHG7YKBBXX.ped', 'testData/K00150_0149_AHG7YKBBXX.relatedness2')
		self.assertEqual(result, True)
	...
	def test_duplicate_sample1(self):
		...
		result, comment = relatedness_test('testData/210604_A00748_0108_AHWVTGDMXX.ped', 'testData/210604_A00748_0108_AHWVTGDMXX.relatedness2')
		self.assertEqual(result, True)

	def test_tso_no_one_related_unexpected_related(self):

		# relatedness a duplicate sample - 18M01316	21M10702
		result, comment = relatedness_test('testData/210709_NB551319_0232_AHF2JFBGXJ.ped', 'testData/210709_NB551319_0232_AHF2JFBGXJ_duplicate.relatedness2')
		self.assertEqual(result, False)
